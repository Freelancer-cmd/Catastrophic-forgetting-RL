...
if __name__ == "__main__":
    ...
    evaluate(ENV_CONFIG, AGENT_CONFIG, {'--train': True, '--episodes': 1500, '--recover': False, '--no-display': True, '--seed': 10, '--verbose': True, '--name-from-config': False, '--recover-from': False})
